...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1925933223ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"ru",server:"1",table:"",db:"",token:"766a482375607b2a50772a485c34534d",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Обзор",pma_text_left_default_tab:"Структура",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"3600",logged_in:true,is_https:false,rootPath:"/openserver/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"cookie",user:"root"});
...
<body>
      ...
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          <a href="index.php?route=/" title="На главную"><img src="themes/dot.gif" title="На главную" alt="На главную" class="icon ic_b_home"></a>
                      ...
                      <a class="logout disableAjax" href="index.php?route=/logout" title="Выход"><img src="themes/dot.gif" title="Выход" alt="Выход" class="icon ic_s_loggoff"></a>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=php-auth_areaweb&table=users">`php-auth_areaweb`.`users`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="766a482375607b2a50772a485c34534d">
...
$.extend(defaultValues, {
  ...
  <div id="prefs_autoload" class="alert alert-primary print_ignore hide" role="alert">
    <form action="index.php?route=/preferences/manage" method="post" class="disableAjax">
        ...
        Ваш браузер содержит настройки phpMyAdmin для данного домена. Хотите импортировать их для текущей сессии?        <br>
        <a href="#yes">Да</a>
        / <a href="#no">Нет</a>
        / <a href="#delete">Удалить настройки</a>
    </form>
</div>
